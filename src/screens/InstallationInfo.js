...
export default function HomeScreen({ navigation }) {
    ...
    for (let i = 4; i < 101; i++) {
        if (
            i.toString()[i.toString().length - 1] == 1 &&
            i.toString()[0] != 1
        ) {
    ...
    function checkInstallInfo() {
        if (!projectType) {
            ...
            Alert.alert(
                "Form Incomplete",
                "Please provide a workspace location"
            );
        } else if (!bathroomLocation) {
            Alert.alert(
                "Form Incomplete",
                "Please provide a bathroom location"
            );
        ...
        if (!waterShutOff) {
            Alert.alert(
                "Form Incomplete",
                "Please provide water shut off type"
            );
            ...
            Alert.alert(
                "Form Incomplete",
                "Please indicate if a permit is required"
            );
                            ...
                            <View style={styles.right}>
                                <RNPickerSelect
                                    ...
                                    items={[
                                        ...
                                        {
                                            label:
                                                "Building Shutoff(Need Approval)",
                                            value:
                                                "Building Shutoff(Need Approval)",
                                        },
                                    ]}
